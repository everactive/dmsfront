...
export default {    
    ...
    'register-tt-code':         'snap known serial\ntype: serial\nauthority-id: some-authority\nrevision: 4\nbrand-id: some-brand\nmodel: some-model\nserial: \'XXXXXXX\'\ndevice-key:\n...',
    'register-tt-cmd':          'snap kown serial',
    'register-tt-1':            'To obtain the serial number, run',
    'register-tt-2':            'Select everything after serial, ',
    'register-tt-3':            'including quotes if present.',
    'register-tt-4':            ' In the below example,',
    'register-tt-5':            'the serial number would be ',
    'register-tt-serial':       '\'XXXXXXX\'',
    'register-tt-6':            ', including the quotes!',
    'remove':                   'Remove',
    'result':                   'Result',
    'role':                     'Role',
    'save':                     'Save',
